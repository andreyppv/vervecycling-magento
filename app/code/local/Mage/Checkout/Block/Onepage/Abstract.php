...
/* */
    ...
    public function getCountryHtmlSelect($type)
    {
        ...
        {
            if(!in_array($option['value'],$countryIds) && !empty($option['value']))
            {
                unset($options[$key]);
            }        
        } */
        ...
        {            
            ...
            {
                $options[$key]['label'] = Mage::helper('checkout')->__('Please select your country');
                break;
            }
        }
        ...
        $select = $this->getLayout()->createBlock('core/html_select')
            ...
            //->setTitle(Mage::helper('checkout')->__(''))

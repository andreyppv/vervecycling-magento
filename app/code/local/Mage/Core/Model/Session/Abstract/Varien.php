...
class Mage_Core_Model_Session_Abstract_Varien extends Varien_Object
{
    ...
    public function start($sessionName=null)
    {
        ...
        $cookieParams = array(
            ...
            'path'     => $cookie->getPath(),
            'domain'   => (Mage::app()->getStore()->getId()) ? $cookie->getConfigDomain() : str_replace('www.','',$cookie->getConfigDomain()),
        ...
        if (isset($cookieParams['domain'])) {
            $cookieParams['domain'] = (Mage::app()->getStore()->getId()) ? $cookie->getDomain() : str_replace('www.','',$cookie->getDomain());
        }

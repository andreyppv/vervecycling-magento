<?php
 ...
 class Verve_Cycling_Block_Product_View_Options_Type_Select extends Mage_Catalog_Block_Product_View_Options_Type_Select{
         ...
         if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_DROP_DOWN
             ...
             $select = $this->getLayout()->createBlock('core/html_select')
                 ->setData(array(
                     ...
                     'class' => $require.' selectpicker form-control'
                 ));
             if ($_option->getType() == Mage_Catalog_Model_Product_Option::OPTION_TYPE_DROP_DOWN) {
                 $select->setName('options['.$_option->getid().']')
                     ->addOption('', $this->__($this->escapeHtml($_option->getTitle())));
             } else {
                 $select->setName('options['.$_option->getid().'][]');

...
class MagicToolbox_Magic360_Helper_Image extends Mage_Core_Helper_Abstract {
    ...
    public function init($imageFile=null) {
        ...
        $this->_cacheBaseDir = $this->_baseDir = Mage::getBaseDir('media').DS.'magictoolbox'.DS.'magic360';
    ...
    public function setBaseFile($file) {
        ...
        if(!$file || !file_exists($baseFile)) {
            throw new Exception(Mage::helper('magic360')->__('Image file was not found.'));
        }
    ...
    protected function _getWatermarkFilePath() {
        ...
        if($file) {
            ...
            } else if($this->_fileExists($baseDir.'/watermark/websites/'.$storeId.$file)) {
                $filePath = $baseDir.'/watermark/websites/'.$storeId.$file;
            } else if($this->_fileExists($baseDir.'/watermark/default/'.$file)) {
                $filePath = $baseDir.'/watermark/default/'.$file;
            } else if($this->_fileExists($baseDir.'/watermark/'.$file)) {
    ...
    public function clearCache() {
        $directory = Mage::getBaseDir('media').DS.'magictoolbox'.DS.'magic360'.DS.'cache'.DS;
